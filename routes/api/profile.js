...
router.get(
  ...
  (req, res) => {
    // we want to fetch the current user profile
    const errors = {};
...
router.post(
  ...
  (req, res) => {
    ...
    Profile.findOne({ user: req.user.id }).then((profile) => {
      // Add the experience and return the profile with the new experince
      const newExp = {
...
router.post(
  ...
  (req, res) => {
    ...
    Profile.findOne({ user: req.user.id }).then((profile) => {
      // Add the education and return the profile with the new education
      const newEdu = {
